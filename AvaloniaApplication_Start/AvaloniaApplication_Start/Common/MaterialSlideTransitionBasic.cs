...
{
    public class MaterialSlideTransitionBasic : IPageTransition
    {
        /// <summary>
        /// 动画持续时间
        /// </summary>
        ...
        public async Task Start(Visual? from, Visual? to, bool forward, CancellationToken cancellationToken)
        {
            ...
            if (from != null)
            {
                ...
                tasks.Add(fadeOutAnimation.RunAsync(from, cancellationToken));
            }
    ...
    /// </summary>
    public class MaterialSlideScaleTransitionBasic : IPageTransition
    {
